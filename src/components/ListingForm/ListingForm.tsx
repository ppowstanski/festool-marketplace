  ...
  return (
    <>
      <div className="flex flex-col md:flex-row gap-8 relative">
        {/* Left Column - Form */}
        <div className="flex-1 md:mr-[732px]">
          {/* Page Title */}
          <div className="mb-6">
        ...
        />
          ...
          <button
            ...
            className="md:hidden fixed bottom-6 right-6 z-40 px-6 py-3 bg-[#39b54a] text-white font-semibold rounded-full hover:bg-[#39b54a]/90 transition-colors flex items-center gap-2 shadow-2xl"
          >

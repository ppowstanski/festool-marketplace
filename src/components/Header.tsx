        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex items-center gap-6">
              <a href="#" className="text-[#ededed] font-medium text-sm hover:text-[#39b54a] transition-colors">
                Dashboard
              </a>
              <a href="#" className="text-[#a3a3a3] font-medium text-sm hover:text-[#39b54a] transition-colors">
                My Listings
              </a>
              <a href="#" className="text-[#a3a3a3] font-medium text-sm hover:text-[#39b54a] transition-colors">
                Messages
          ...
          <div className="flex items-center gap-4">
            ...
            {user && (
              <>
                ...
                <button
                  onClick={logout}
                  className="hidden sm:block px-4 py-2 text-sm font-medium text-[#a3a3a3] hover:text-[#ededed] hover:bg-[#39b54a]/10 rounded-lg transition-colors"
                >
                  Logout
                </button>
              </>

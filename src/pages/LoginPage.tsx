...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-[#0a0a0a]">
      {/* Left Panel - Branding */}
      <div className="lg:w-1/2 bg-[#39b54a]/10 p-12 lg:p-16 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-[#39b54a]/20 relative overflow-hidden">
